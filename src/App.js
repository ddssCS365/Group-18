  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route
          path="/admin/quick-action/therapists"
          element={<ViewTherapists />}
        />
        <Route
          path="/admin/quick-action/billing-settings"
          element={<BillingSettings />}
        />
        <Route
          path="/admin/quick-action/appointments"
          element={<Appointments />}
        />
        <Route
          path="/admin/quick-action/add-therapist"
        ...
        <Route
          path="/patient/view-therapist/message-therapist"
          element={<MessageTherapist />}
        />
      </Routes>
    </div>
  );
